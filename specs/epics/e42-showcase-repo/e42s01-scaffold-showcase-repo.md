...
Trigger: manual — maintainer starts the e42 build in the v2.8x train.
...
### 18. Out of scope
- Building any feature of the app (e42s02).
- Bug-fix trail (e42s03).
- Linking from README/docs site or e37 fixture registration (e42s04).
...
### 20. References
- specs/epics/e42-showcase-repo/epic.yaml (source change request 2026-07-03).
