...
The showcase repo (built in e42s01-s03) demonstrates bigpowers in action — but
...
Precondition: showcase repo is public and populated (e42s01-s03 complete).
...
- e42s01-s03 showcase repo (direction: in) — must exist before linking.
...
Scenario: Showcase registered as fixture candidate
  ...
  THEN grep -qi 'showcase' specs/epics/e37-golden-stories/epic.yaml exits 0
...
- specs/epics/e37-golden-stories/epic.yaml (fixture registration target).
- specs/epics/e42-showcase-repo/epic.yaml (parent epic).
