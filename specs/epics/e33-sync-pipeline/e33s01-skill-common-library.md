...
pattern at its root and is the foundation the rest of e33 (and e39's future
...
- scripts/sync-skills.sh and 12 sibling scripts (perennial, direction: out) —
  will source this library in e33s02–e33s04.
- Downstream e39 (knowledge graph / OKF adoption, depends_on e33): the future
...
- Output convention of parse_frontmatter (globals vs stdout key=value) —
  implementer's choice, but must be consistent for all e33 consumers.
...
### 18. Out of scope
- Refactoring any existing script to use the library (e33s02–e33s04).
- Render-target functions for sync-skills.sh (e33s03).
