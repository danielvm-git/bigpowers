...
- Does NOT modify scripts/install.sh (e50s02) or verify-install.sh (e50s04).
...
### 18. Out of scope
- Global `~/.codex/` install (e50s02).
- using-bigpowers docs (e50s03).
- verify-install harness (e50s04).
