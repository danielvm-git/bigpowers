...
pipeline output. The e37 golden stories extend this with agent-driven tests
...
This story adds `--agent` mode: headless chain execution of e37 golden stories
...
Precondition: e37s03 golden story YAMLs exist at specs/benchmarks/golden/g-*.yaml.
...
.github/workflows/e37-golden-deepseek.lock.yml (compiled workflow).
...
- e37s03 golden story YAMLs (direction: in) — define what to test.
...
### 18. Out of scope
- Modifying the golden story YAML format (that is e37s03).
...
- Flake baseline: how many flaked runs are acceptable before a story is flagged
  as flaky? Deferred until 3 weekly runs establish baseline per e37 epic note.

### 20. References
- specs/QUALITY-GUARANTEE-STRATEGY.md (golden suite design).
- specs/epics/e37-golden-stories/epic.yaml (parent epic, spike verdict).
- .github/workflows/e37-golden-deepseek.lock.yml (compiled G-01 workflow).
- specs/benchmarks/golden/ (golden story YAML directory — created by e37s03).
