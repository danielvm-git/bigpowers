...
scoring is meaningless. The e37s01 spike confirmed the harness (gh-aw +
...
- run-golden-suite.sh --agent (e37s04, direction: in) — copies/uses this fixture for G-01/G-02 runs.
- Golden story YAMLs (e37s03, direction: in) — reference this fixture path in their prompts/graders.
...
- Fixture location (config) — path specs/benchmarks/fixtures/minimal-api/
  is referenced by e37s03 YAMLs and e37s04 runner; changing it is a
  coordinated rename.
...
### 18. Out of scope
- Copy-to-scratch / reset mechanics between golden runs (e37s04 runner concern).
...
- Golden story YAML definitions (e37s03).
...
- specs/epics/e37-golden-stories/epic.yaml (e37s02 verify command).
- specs/PLAN-AUDIT_LATEST.md (2026-07-02 e31/e37 split rationale).
