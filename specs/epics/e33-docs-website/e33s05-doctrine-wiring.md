# Story e33s05: Doctrine wiring — site content is generated, never edited
...
4. Add `website/src/content/` to `.gitignore` so generated site content is
   ...
   entry in `.npmignore` from e33s01.
...
- The site link in README goes to a 404 until e33s04 deploys — add the link
  after e33s04 is verified working
