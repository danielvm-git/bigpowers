...
Trigger: manual — follows e43s01 completion.
Preconditions: showcase repo scaffolded with committed cockpit (e43s01); the
...
Context: existing (showcase repo created in e43s01).
...
### 18. Out of scope
- Bug-fix trail (e43s03) — this story covers the feature half only.
- Building more than one feature epic — one complete trail is the deliverable.
- Registering the trail as an e37 fixture (e43s04).
- Any edits to files in THIS repo.

### 19. Open questions
Not applicable — the 8-step cycle and e40 metrics pipeline are both defined;
only the feature choice is deferred to e43s01's scope output.

### 20. References
- specs/epics/e43-showcase-repo/epic.yaml (source and v2.8x slotting note).
...
- specs/epics/e42-golden-stories/ (downstream fixture consumer).
