...
Precondition: showcase repo exists with a built feature (e43s02).
...
- e43s02 built feature (direction: in) — the feature containing the defect.
...
- Should the bug be in the feature built in e43s02 or a separate area? Either
  is fine — the trail matters more than the location.

### 20. References
- specs/epics/e43-showcase-repo/epic.yaml (parent epic, bug trail story).
