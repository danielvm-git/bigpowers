...
`render_<target>()` function. This is the architectural core of e28 — the
...
Precondition: e28s01 complete — parse_frontmatter and iterate_skills exist in
...
- scripts/lib/skill-common.sh (e28s01, direction: in) — supplies parse phase.
- regenerate-lockfile.sh, generate-skill-index.sh, build-skill-index.sh
  (perennial, direction: out) — invoked post-render, unchanged here (e28s04
  refactors their internals).
- Downstream e39 (knowledge graph / OKF adoption, depends_on e28): per
...
- Refactoring regenerate-lockfile.sh / index scripts internals (e28s04).
...
- specs/epics/e28-sync-pipeline/e28s01-skill-common-library.md (parse phase).
