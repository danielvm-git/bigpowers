# Story e33s01: Scaffold Astro Starlight site in website/ with local dev
...
website/src/content/. All pages are produced by the prebuild script (e33s02) from
...
2. Configure `astro.config.mjs`: set `title: "bigpowers"`, `description` from
   ...
   sidebar in favor of auto-generated sidebar from the prebuild (e33s02).
...
- Generating any site content (that's e33s02)
- SEO configuration (that's e33s03)
- Deploy workflow (that's e33s04)
