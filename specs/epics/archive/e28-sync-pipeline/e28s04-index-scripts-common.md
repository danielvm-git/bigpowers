...
(e28s01). Divergent parsers are how the lockfile, the index, and the
...
Precondition: e28s01 complete (library exists); e28s02 already routes their
...
- scripts/lib/skill-common.sh (e28s01, direction: in) — single parser.
- scripts/sync-skills.sh (e28s03, direction: in) — invokes all three at the
...
- Downstream e39 (depends_on e28): e39's OKF `index.md` is a derived view
...
- specs/epics/e28-sync-pipeline/e28s01-skill-common-library.md (shared parser).
