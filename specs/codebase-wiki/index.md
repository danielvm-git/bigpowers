---
type: Index
generated_at: 2026-07-03T19:58:03.916374+00:00
total_concepts: 152
---
...
| [e01s02](./e01s02.md) | Supply-chain + OWASP in `audit-code` | medium | 102 |
...
| [e02s02](./e02s02.md) | Verification Script template in `plan-work` | medium | 6 |
| [e02s03](./e02s03.md) | UAT checkpoint in `execute-plan` | medium | 3 |
| [e02s04](./e02s04.md) | RED/GREEN/REFACTOR commits in `develop-tdd` | medium | 4 |
| [e03s01](./e03s01.md) | `research-first`, `scope-work`, `slice-tasks`, `grill-with-d | medium | 12 |
| [e03s02](./e03s02.md) | `using-bigpowers` lifecycle updated | medium | 4 |
| [e04s01](./e04s01.md) | Handoff + compaction in `session-state` | medium | 5 |
| [e04s02](./e04s02.md) | `terse-mode` caveman rules (existing) | medium | 4 |
| [e04s03](./e04s03.md) | `organize-workspace` gitignore section (existing) | medium | 3 |
| [e05s01](./e05s01.md) | `model:` on all SKILL.md | medium | 2 |
| [e05s02](./e05s02.md) | `execute-plan` isolation + STATE.md channel | medium | 3 |
...
| [e06s03](./e06s03.md) | `audit-code` metadata checks | medium | 102 |
| [e07s01](./e07s01.md) | Demeter in CONVENTIONS.md + audit-code | medium | 102 |
...
| [e09s01](./e09s01.md) | stocktake-skills, evolve-skill, search-skills, compose-workf | medium | 47 |
| [e09s02](./e09s02.md) | `specs/METHODOLOGY.md` | none | 0 |
| [e09s03](./e09s03.md) | craft-skill README generator | medium | 3 |
| [e09s04](./e09s04.md) | Iterative retrieval in dispatch-agents / delegate-task | medium | 6 |
| [e09s05](./e09s05.md) | evolve-skill benchmark path documented; run `bash scripts/sc | medium | 13 |
| [e09s06](./e09s06.md) | Add HARD GATE enforcement callouts to 35 skills | medium | 4 |
| [e10s01](./e10s01.md) | profiles/swift.md, typescript-vue.md, node-service.md | none | 0 |
| [e10s02](./e10s02.md) | seed-conventions profile picker | medium | 3 |
| [e11s01](./e11s01.md) | Dashboard TUI UAT | medium | 1 |
| [e11s02](./e11s02.md) | Dashboard Web UAT | medium | 1 |
| [e11s03](./e11s03.md) | BCP accounting + cycle-time ledger | medium | 4 |
| [e11s04](./e11s04.md) | Plan retirement + scope correction | medium | 1 |
| [e11s05](./e11s05.md) | SKILL-INDEX fix + dead code removal | medium | 5 |
| [e12s01](./e12s01.md) | Pi skill generation — .pi/skills/<name>/SKILL.md | low | 1 |
| [e12s02](./e12s02.md) | Pi prompt templates — .pi/prompts/<name>.md | low | 1 |
| [e12s03](./e12s03.md) | Pi package config — package.json with pi manifest | medium | 2 |
| [e12s04](./e12s04.md) | sync-skills.sh pi target | medium | 2 |
...
| [e18s01](./e18s01.md) | audit-code as hard gate in build-epic step 6 | medium | 116 |
...
| [e18s05](./e18s05.md) | Add auto-timing to critical-path skills for stocktake effect | medium | 7 |
| [e19s01](./e19s01.md) | craft-skill: quick-fix — fast-path for trivial data-only fix | medium | 13 |
| [e21s01](./e21s01.md) | MCP-native skill discovery — register skills as MCP tools | medium | 98 |
| [e21s02](./e21s02.md) | Wire opensrc into research-first for learn-before-build | medium | 14 |
| [e21s03](./e21s03.md) | CI-aware skills — read preflight commands from AGENTS.md | medium | 3 |
| [e21s04](./e21s04.md) | compose-workflow → AGENTS.md agentic stack mapping | medium | 6 |
| [e25s01](./e25s01.md) | Promote ID tracking from YAML comments to first-class fields | low | 1 |
| [e25s02](./e25s02.md) | Emit FR-XX / UJ-XX REQUIREMENTS_TRACE.yaml on migration | low | 1 |
| [e25s03](./e25s03.md) | Promote handoff block from optional to mandatory Step 4 outp | medium | 2 |
...
| [e28s01](./e28s01.md) | Scaffold Astro Starlight site in website/ with local dev | medium | 4 |
| [e28s02](./e28s02.md) | Source-mapping prebuild — pages generated from repo sources | medium | 24 |
| [e28s03](./e28s03.md) | SEO + AI discoverability layer | medium | 2 |
...
| [e32s01](./e32s01.md) | Create docs/references/kent-beck.md (XP, TDD origins, Tidy F | low | 1 |
| [e32s02](./e32s02.md) | Create docs/references/fowler.md (refactoring catalog, code  | low | 1 |
| [e32s03](./e32s03.md) | Create docs/references/feathers.md (seams, characterization  | low | 1 |
| [e32s04](./e32s04.md) | Create docs/references/pragmatic-programmer.md (DRY, broken  | low | 1 |
| [e32s05](./e32s05.md) | Create docs/references/rich-hickey.md (simple vs easy, compl | low | 1 |
| [e32s06](./e32s06.md) | Create docs/references/sandi-metz.md (SOLID in practice, mes | medium | 3 |
| [e32s07](./e32s07.md) | Create docs/references/ddd.md (bounded contexts, context map | low | 1 |
| [e32s08](./e32s08.md) | Create docs/references/accelerate.md (DORA four keys) | medium | 2 |
| [e32s09](./e32s09.md) | Update PRINCIPLES.md to credit Beck, Fowler, Feathers, Hunt  | low | 1 |
| [e32s10](./e32s10.md) | Cross-reference new docs from SKILL.md bodies | medium | 2 |
| [e33s01](./e33s01.md) | Create scripts/lib/skill-common.sh with shared functions (re | medium | 2 |
...
| [e33s04](./e33s04.md) | Refactor regenerate-lockfile.sh, generate-skill-index.sh, bu | medium | 330 |
...
| [e36s03](./e36s03.md) | Remove F.I.R.S.T rubric restatement from enforce-first and a | medium | 130 |
...
| [e37s04](./e37s04.md) | Add --agent mode to run-golden-suite.sh: headless chain exec | medium | 203 |
...
| [e42s02](./e42s02.md) | Build one feature epic end-to-end via the 8-step build-epic  | medium | 572 |
...
| [e35s01](./e35s01.md) | BCP Plus counter integration — install and smoke-test big-co | medium | 25 |
| [e35s02](./e35s02.md) | BCP Plus template — 13-dimension breakdown in story specs | medium | 1 |
| [e35s03](./e35s03.md) | NFR Gate integration — security-review and wire-observabilit | medium | 13 |
| [e35s04](./e35s04.md) | Build-epic integration — BCP Plus in story sizing workflow | medium | 8 |
