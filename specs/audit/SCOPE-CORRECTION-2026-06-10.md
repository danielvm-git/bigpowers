...
2. 🔧 **UAT dashboard TUI + web** — ~4 BCPs, create specs/plans/PLAN-dashboard-uat.md
3. 🔧 **Complete BCP accounting + ledger** — ~4 BCPs, create specs/plans/PLAN-skill-metrics.md
...
4. **Document in specs/plans/** — Archive PLAN-*.md files with notes on what was actually done vs. planned
...
- [ ] Add specs/audit/SCOPE-CORRECTION-2026-06-10.md (this file) to the record
