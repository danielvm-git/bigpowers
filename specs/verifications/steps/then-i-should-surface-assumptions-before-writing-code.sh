...
if grep -q "clarif\|assumption\|Success criteria\|How will you know" skills/elaborate-spec/SKILL.md \
   && grep -q "Pre-flight\|define-success\|success criteria" skills/plan-work/SKILL.md; then
  exit 0
fi
