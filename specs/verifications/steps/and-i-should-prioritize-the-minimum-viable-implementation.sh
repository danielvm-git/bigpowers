...
if grep -qi "minimum\|minimal\|smallest possible\|minimum viable" skills/plan-work/SKILL.md \
   && grep -qi "minimal code\|minimum\|only enough" skills/develop-tdd/SKILL.md; then
  exit 0
fi
