...
install_grep -q 'install_qwen()' && pass 'install.sh: install_qwen()' || fail 'install.sh: missing install_qwen()'
install_grep -q 'uninstall_qwen()' && pass 'install.sh: uninstall_qwen()' || fail 'install.sh: missing uninstall_qwen()'
install_grep -q 'QWEN_SKILLS_DIR=' && pass 'install.sh: skills dir var' || fail 'install.sh: missing skills dir var'
install_grep -q 'install_qwen' && install_grep -q 'uninstall_qwen' && pass 'install.sh: dispatch wired' || fail 'install.sh: dispatch missing qwen'
...
install_grep -q 'QWEN_HOOK_SRC=' && pass 'install.sh: hook src' || fail 'install.sh: missing hook src'
