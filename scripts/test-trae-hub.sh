...
install_grep -q 'install_trae()' && pass 'install.sh: install_trae()' || fail 'install.sh: missing install_trae()'
install_grep -q 'uninstall_trae()' && pass 'install.sh: uninstall_trae()' || fail 'install.sh: missing uninstall_trae()'
install_grep -q 'TRAE_SKILLS_DIR=' && pass 'install.sh: skills dir var' || fail 'install.sh: missing skills dir var'
install_grep -q 'install_trae' && install_grep -q 'uninstall_trae' && pass 'install.sh: dispatch wired' || fail 'install.sh: dispatch missing trae'
...
install_grep -q 'TRAE_HOOK_SRC=' && pass 'install.sh: hook src' || fail 'install.sh: missing hook src'
