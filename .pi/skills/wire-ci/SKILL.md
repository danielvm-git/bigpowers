...
Deploy workflows are **not** bundled: they are platform-specific. See [REFERENCE.md](../../../skills/wire-ci/REFERENCE.md) for a worked example.
...
See [REFERENCE.md](../../../skills/wire-ci/REFERENCE.md). Exit codes: `0` clean, `1` YAML syntax errors, `2` warnings only.
