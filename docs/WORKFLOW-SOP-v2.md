...
- [`specs/SKILL-SEARCH-INDEX.md`](../specs/SKILL-SEARCH-INDEX.md) — **Auto-generated** canonical catalog of all skills (regenerated by `bash scripts/build-skill-index.sh`); find the right skill with `search-skills`
