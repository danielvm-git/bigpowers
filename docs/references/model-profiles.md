...
| Skill | Model |
|-------|-------|
| `/tmp/bigpowers-pr/skills/align-grid` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/assess-impact` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/audit-code` | **Haiku** |
| `/tmp/bigpowers-pr/skills/audit-plan` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/build-epic` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/change-request` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/commit-message` | **Haiku** |
| `/tmp/bigpowers-pr/skills/compose-workflow` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/context7-mcp` | **Haiku** |
| `/tmp/bigpowers-pr/skills/craft-skill` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/deepen-architecture` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/define-language` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/define-success` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/delegate-task` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/deploy` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/design-interface` | **Opus** |
| `/tmp/bigpowers-pr/skills/develop-tdd` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/diagnose-root` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/diagnose-stall` | **Haiku** |
| `/tmp/bigpowers-pr/skills/dispatch-agents` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/edit-document` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/elaborate-spec` | **Opus** |
| `/tmp/bigpowers-pr/skills/enforce-first` | **Haiku** |
| `/tmp/bigpowers-pr/skills/evolve-skill` | **Opus** |
| `/tmp/bigpowers-pr/skills/execute-plan` | **Haiku** |
| `/tmp/bigpowers-pr/skills/extract-design` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/fix-bug` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/gate-trace` | **Haiku** |
| `/tmp/bigpowers-pr/skills/generate-allure-report` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/grill-me` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/grill-with-docs` | **Opus** |
| `/tmp/bigpowers-pr/skills/guard-git` | **Haiku** |
| `/tmp/bigpowers-pr/skills/harden-vps` | **Haiku** |
| `/tmp/bigpowers-pr/skills/hook-commits` | **Haiku** |
| `/tmp/bigpowers-pr/skills/inspect-quality` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/investigate-bug` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/kickoff-branch` | **Haiku** |
| `/tmp/bigpowers-pr/skills/maintain-wiki` | **Haiku** |
| `/tmp/bigpowers-pr/skills/map-codebase` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/migrate-spec` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/model-domain` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/orchestrate-project` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/organize-workspace` | **Haiku** |
| `/tmp/bigpowers-pr/skills/plan-refactor` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/plan-release` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/plan-tests` | **Opus** |
| `/tmp/bigpowers-pr/skills/plan-work` | **Opus** |
| `/tmp/bigpowers-pr/skills/publish-package` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/quick-fix` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/release-branch` | **Haiku** |
| `/tmp/bigpowers-pr/skills/request-review` | **Opus** |
| `/tmp/bigpowers-pr/skills/research-first` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/reset-baseline` | **Haiku** |
| `/tmp/bigpowers-pr/skills/respond-review` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/run-benchmark` | **Haiku** |
| `/tmp/bigpowers-pr/skills/run-evals` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/run-planning` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/scope-work` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/search-skills` | **Haiku** |
| `/tmp/bigpowers-pr/skills/security-review` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/seed-conventions` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/session-state` | **Haiku** |
| `/tmp/bigpowers-pr/skills/setup-environment` | **Haiku** |
| `/tmp/bigpowers-pr/skills/simulate-agents` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/slice-tasks` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/smoke-test` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/spike-prototype` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/stocktake-skills` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/survey-context` | **Haiku** |
| `/tmp/bigpowers-pr/skills/terse-mode` | **Haiku** |
| `/tmp/bigpowers-pr/skills/trace-requirement` | **Haiku** |
| `/tmp/bigpowers-pr/skills/using-bigpowers` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/validate-contracts` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/validate-fix` | **Haiku** |
| `/tmp/bigpowers-pr/skills/verify-work` | **Haiku** |
| `/tmp/bigpowers-pr/skills/visual-dashboard` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/wire-ci` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/wire-observability` | **Sonnet** |
| `/tmp/bigpowers-pr/skills/write-document` | **Sonnet** |
